...
public class AdminEmployee extends Employee {
    ...
    @Override
    public boolean canViewDatabase() { return true; }
    
    @Override 
    public boolean canViewAllRecords() { return true; }
    
    @Override
    public boolean canAddEmployee() { return true; }

    @Override
    public boolean canEditBasicInfo() { return true; }

    @Override
    public boolean canDeleteEmployee() { return true; }

    @Override
    public boolean canEditFinancials() { return true; }
}
